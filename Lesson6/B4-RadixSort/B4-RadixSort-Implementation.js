function radixSort(arr, radix) {
	...
	rounds = Math.ceil(Math.log2(maxVal) / Math.log2(radix));
...
function _extractRadixDigit(number, radix, digitOffset) {
...
function runPerformanceTestRadixSort(tstName, shirtSz) {
	...
	let strStats = generateStatsLine(tstName, shirtSz, tSortStart, tSortComplete, countErrors);
